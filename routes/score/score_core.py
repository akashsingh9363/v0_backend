...
def update_score():
    ...
    match_outcome = data.get('match_outcome', 'NORMAL')
    ...
    if match_outcome == "WALKOVER":
        ...
        return jsonify({
            "message": "Match completed as walkover",
            "match_id": match.id,
            "match_outcome": "WALKOVER",
    ...
    try:
        ...
        return jsonify({'error': 'Score format is invalid. Use "A-B"'}), 400
